...
router.post("/createuser", [body("name", "Name must be").isLength({ min: 1 }), body("email", "Enter a valid email").isEmail(), body("password", "Password must be at least 5 characters.").isLength({ min: 5 })], async (req, res) => {
